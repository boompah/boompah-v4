...
<div class="container contact-project-details">
  <div class="showcase">
    <h2>Guidelines</h2>
    <div class="row guidelines">
      <div class="half">
        <h3><i class="fa fa-file-text-o"></i> Project Brief</h3>
    ...
    <div class="row guidelines">
      ...
      <div class="half">
        <h3><i class="fa fa-coffee"></i> One on One Consultations</h3>
        <p>We have 2-hour available for individual consultations. Do you need a fresh set of eyes on a project? An actionable list of tweaks and changes? Ideas for new content? Not a problem.
